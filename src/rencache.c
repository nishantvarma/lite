...
** commands when issued. At the end of the frame we write the commands to a
** grid of hash values, take the cells that have changed since the previous
** frame, merge them into dirty rectangles and redraw only those regions
*/
